      ...
      <main className="max-w-7xl mx-auto px-4 md:px-8 py-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
          {[
            ...
            { label: 'Commandes', value: report?.transaction_count || 0, icon: <Package className="text-blue-500" />, trend: '+2', color: 'bg-blue-50' }, // Dynamique
            { label: 'Stock Faible', value: '4', icon: <AlertTriangle className="text-amber-500" />, trend: '-10%', color: 'bg-amber-50' }, // TODO: Rendre dynamique via API
            { label: 'Patients', value: '128', icon: <Users className="text-purple-500" />, trend: '+5%', color: 'bg-purple-50' }, // TODO: Rendre dynamique via API
          ].map((stat, i) => (
          ...
          <div className="space-y-8">
            ...
            <div className="bg-white rounded-[40px] border border-slate-100 p-8 shadow-sm">
              ...
              <div className="space-y-4">
                {[
                  // TODO: Rendre ces alertes dynamiques via API
